...
int main(int argc, char *argv[])
{
    ...
    POINTER->push_back(Jugador(15, 6, "Tomas"));
    POINTER->push_back(Jugador(20, 3, "Gaston"));
    POINTER->push_back(Jugador(13, 8, "David"));
    POINTER->push_back(Jugador(18, 18, "Yefim"));
    POINTER->push_back(Jugador(23, 99, "JuanDeNuevo"));
